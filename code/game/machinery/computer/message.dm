						...
						if(isnull(PDARec))
							...
							if (!customrecepient.silent)
								...
								if( customrecepient.loc && ishuman(customrecepient.loc) )
									...
									to_chat("\icon[customrecepient] <b>Message from [customsender] ([customjob]), </b>\"[custommessage]\" (<a href='byond://?src=\ref[src];choice=Message;skiprefresh=1;target=\ref[src]'>Reply</a>)")
