...
<BR><b>Severity:</b> [Dis.severity]"}
				...
				switch(href_list["field"])
					if("fingerprint")
						if(active1)
							var/t1 = stripped_input(usr, "Please input fingerprint hash:", "Med. records", active1.fields["fingerprint"], null)
					...
					if("species")
						if(active1)
							var/t1 = stripped_input(usr, "Please input species name", "Med. records", active1.fields["species"], null)
							if(!canUseMedicalRecordsConsole(usr, t1, a1))
								return
							active1.fields["species"] = t1
					if("mi_dis")
						if(active2)
							var/t1 = stripped_input(usr, "Please input minor disabilities list:", "Med. records", active2.fields["mi_dis"], null)
							if(!canUseMedicalRecordsConsole(usr, t1, null, a2))
								return
							active2.fields["mi_dis"] = t1
					if("mi_dis_d")
						if(active2)
							var/t1 = stripped_multiline_input("Please summarize minor dis.:", "Med. records", active2.fields["mi_dis_d"], null)
							if(!canUseMedicalRecordsConsole(usr, t1, null, a2))
								return
							active2.fields["mi_dis_d"] = t1
					if("ma_dis")
						if(active2)
							var/t1 = stripped_input(usr, "Please input major diabilities list:", "Med. records", active2.fields["ma_dis"], null)
							if(!canUseMedicalRecordsConsole(usr, t1, null, a2))
								return
							active2.fields["ma_dis"] = t1
					if("ma_dis_d")
						if(active2)
							var/t1 = stripped_multiline_input("Please summarize major dis.:", "Med. records", active2.fields["ma_dis_d"], null)
							if(!canUseMedicalRecordsConsole(usr, t1, null, a2))
								return
							active2.fields["ma_dis_d"] = t1
					if("alg")
						if(active2)
							var/t1 = stripped_input(usr, "Please state allergies:", "Med. records", active2.fields["alg"], null)
							if(!canUseMedicalRecordsConsole(usr, t1, null, a2))
								return
							active2.fields["alg"] = t1
					if("alg_d")
						if(active2)
							var/t1 = stripped_multiline_input("Please summarize allergies:", "Med. records", active2.fields["alg_d"], null)
							if(!canUseMedicalRecordsConsole(usr, t1, null, a2))
								return
							active2.fields["alg_d"] = t1
					if("cdi")
						if(active2)
							var/t1 = stripped_input(usr, "Please state diseases:", "Med. records", active2.fields["cdi"], null)
							if(!canUseMedicalRecordsConsole(usr, t1, null, a2))
								return
							active2.fields["cdi"] = t1
					if("cdi_d")
						if(active2)
							var/t1 = stripped_multiline_input("Please summarize diseases:", "Med. records", active2.fields["cdi_d"], null)
							if(!canUseMedicalRecordsConsole(usr, t1, null, a2))
								return
							active2.fields["cdi_d"] = t1
					if("notes")
						if(active2)
							var/t1 = stripped_multiline_input("Please summarize notes:", "Med. records", active2.fields["notes"], null)
							if(!canUseMedicalRecordsConsole(usr, t1, null, a2))
								return
					...
					if("b_dna")
						if(active2)
							var/t1 = stripped_input(usr, "Please input DNA hash:", "Med. records", active2.fields["b_dna"], null)
							if(!canUseMedicalRecordsConsole(usr, t1, null, a2))
								return
				...
				while(active2.fields[text("com_[]", counter)])
					counter++
				active2.fields[text("com_[]", counter)] = text("Made by [] ([]) on [] [], []<BR>[]", authenticated, rank, worldtime2text(), time2text(world.realtime, "MMM DD"), year_integer+540, t1,)
				...
				if(!( printing ))
					...
					if(active2 in data_core.medical)
						...
						while(active2.fields[text("com_[]", counter)])
							...
							counter++
						P.name = text("MR-[] '[]'", data_core.medicalPrintCount, active1.fields["name"])
					else
