...
/obj/machinery/vending/clothing
	...
	products = list("Clothing" = list(/obj/item/clothing/head/that=2,/obj/item/clothing/head/fedora=1,/obj/item/clothing/glasses/monocle=1, /obj/item/clothing/glasses/sunglasses/cheap=3,
