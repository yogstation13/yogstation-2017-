...
/obj/machinery/vending/snack/attackby(obj/item/weapon/W, mob/user, params)
	if(fallen_over)
		to_chat(user, "<span class='warning'>[src] is on the ground.</span>")
		return
...
/obj/machinery/vending/security
	...
	products = list("Security Items" = list(/obj/item/weapon/restraints/handcuffs = 8,/obj/item/weapon/restraints/handcuffs/cable/zipties = 10,/obj/item/weapon/grenade/flashbang = 4,/obj/item/device/assembly/flash/handheld = 5,
					/obj/item/weapon/reagent_containers/food/snacks/donut = 12,/obj/item/weapon/storage/box/evidence = 6,/obj/item/device/flashlight/seclite = 4, /obj/item/scope/security=8, /obj/item/weapon/restraints/legcuffs/bola/energy = 10, /obj/item/weapon/extinguisher/mini = 2))
...
/obj/machinery/vending/tool
	...
	icon_state = "tool"
	icon_deny = "tool-deny"
	//req_access_txt = "12" //Maintenance access //Why is this disabled?
