...
/obj/machinery
	...
	var/no_malf_ai_overloading = FALSE //Stops malf AI from blowing shit up
...
/obj/machinery/attack_paw(mob/living/user)
	if(user.a_intent != "harm")
		...
		user.changeNext_move(CLICK_CD_MELEE)
		user.do_attack_animation(src)
		user.visible_message("<span class='danger'>[user.name] smashes against \the [name] with its paws.</span>",\
		"<span class='danger'>You smash against the [name] with your paws.</span>")
