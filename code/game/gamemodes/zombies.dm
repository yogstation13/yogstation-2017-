...
/datum/game_mode/zombies/proc/greet_carrier(datum/mind/carrier)
	...
	carrier.current << "<b>Soon you will become a <span class='warning'>flesh eating zombie</span>. Your sole purpose is to hunt for crew members to infect them.</b>"
