...
/datum/game_mode/clockwork_cult
	...
	protected_jobs = list("AI", "Cyborg", "Security Officer", "Warden", "Detective", "Head of Security", "Captain", "Prison Officer","Security Deputy") //Silicons can eventually be converted
