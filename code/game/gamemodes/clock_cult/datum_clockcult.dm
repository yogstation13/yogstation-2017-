...
/datum/antagonist/clockcultist/on_gain()
	...
	owner.attack_log += "\[[gameTimestamp()]\] <font color=#BE8700>Has been converted to the cult of Ratvar!</font>"
	if(issilicon(owner))
...
/datum/antagonist/clockcultist/on_remove()
	...
	owner.attack_log += "\[[gameTimestamp()]\] <font color=#BE8700>Has renounced the cult of Ratvar!</font>"
	if(isrobot(owner))
