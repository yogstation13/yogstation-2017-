...
/datum/antagonist/cultist/on_gain()
	...
	owner.attack_log += "\[[gameTimestamp()]\] <font color=#960000>Has been converted to the cult of Nar'Sie!</font>"
	..()
...
/datum/antagonist/cultist/on_remove()
	...
	owner.attack_log += "\[[gameTimestamp()]\] <font color=#960000>Has renounced the cult of Nar'Sie!</font>"
	if(!silent_update)
