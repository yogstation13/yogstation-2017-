...
/datum/game_mode/gang
	...
	restricted_jobs = list("Security Officer", "Warden", "Detective", "AI", "Cyborg","Captain", "Head of Personnel", "Head of Security", "Chief Engineer", "Research Director", "Chief Medical Officer", "Prison Officer", "Security Deputy")
	required_players = 20
	required_enemies = 2
