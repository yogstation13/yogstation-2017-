...
/obj/structure/catwalk/Crossed()
	. = ..()
	if(isliving(usr))
		playsound(src, pick('sound/effects/catwalk1.ogg', 'sound/effects/catwalk2.ogg', 'sound/effects/catwalk3.ogg', 'sound/effects/catwalk4.ogg', 'sound/effects/catwalk5.ogg'), 25, 1)
