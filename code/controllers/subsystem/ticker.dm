	...
	if(master_mode == "random" || master_mode == "secret")
		...
		if(master_mode == "secret")
			...
			if(secret_force_mode != "secret")
				...
				if(!smode.can_start())
					message_admins("<font color='blue'>Unable to force secret [secret_force_mode]. [smode.required_players] players and [smode.required_enemies] eligible antagonists needed.</font>")
				else
					mode = smode
