...
#define LIGHT_COLOR_HALOGEN    "#F0FAFA" //Barely visible cyan-ish hue, as the doctor prescribed. rgb(240, 250, 250)sible cyan-ish hue, as the doctor prescribed. rgb(240, 250, 250)