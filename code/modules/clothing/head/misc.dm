...
/obj/item/clothing/head/deputy
	name = "deputy beret"
	desc = "A robust white beret fitted for the members of security who have a lot to learn."
	icon_state = "deputy_beret"
	item_state = "deputy_beret"
	armor = list(melee = 10, bullet = 15, laser = 0, energy = 10, bomb = 10, bio = 0, rad = 0)
	strip_delay = 20
