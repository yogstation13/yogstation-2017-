...
/obj/item/weapon/paperplane/throw_impact(atom/hit_atom)
	...
	if(prob(2))
		if((H.head && H.head.flags_cover & HEADCOVERSEYES) || (H.wear_mask && H.wear_mask.flags_cover & MASKCOVERSEYES) || (H.glasses && H.glasses.flags_cover & GLASSESCOVERSEYES) || (H.dna && H.dna.species && (H.dna.species.specflags & PROTECTEDEYES)) )
			return
