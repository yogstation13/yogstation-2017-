/client/proc/manipulate_organs(mob/living/carbon/C in world)
	...
	set category = "Debug"
	var/operation = input("Select organ operation.", "Organ Manipulation", "cancel") as anything in list("add organ", "add implant", "drop organ/implant", "remove organ/implant", "cancel")
	...
	switch(operation)
		if("add organ")
			...
			var/obj/item/organ/organ = input("Select organ type:", "Organ Manipulation", null) as anything in organs
			organ = organs[organ]
			organ = new organ
			organ.Insert(C)
		...
		if("add implant")
			...
			var/obj/item/weapon/implant/organ = input("Select implant type:", "Organ Manipulation", null) as anything in organs
			organ = organs[organ]
			organ = new organ
			organ.implant(C)
		...
		if("drop organ/implant", "remove organ/implant")
			...
			var/obj/item/organ = input("Select organ/implant:", "Organ Manipulation", null) as anything in organs
			organ = organs[organ]
			if(!organ) return
