...
/datum/buildmode/proc/show_help(mob/user)
	switch(mode)
		if(BASIC_BUILDMODE)
			to_chat(user, "<font color='blue'> ***********************************************************</font>")
			to_chat(user, "<font color='blue'> Left Mouse Button        = Construct / Upgrade</font>")
			to_chat(user, "<font color='blue'> Right Mouse Button       = Deconstruct / Delete / Downgrade</font>")
			to_chat(user, "<font color='blue'> Left Mouse Button + ctrl = R-Window</font>")
			to_chat(user, "<font color='blue'> Left Mouse Button + alt  = Airlock</font>")
			to_chat(user, "")
			to_chat(user, "<font color='blue'> Use the button in the upper left corner to</font>")
			to_chat(user, "<font color='blue'> change the direction of built objects.</font>")
			to_chat(user, "<font color='blue'> ***********************************************************</font>")
		if(ADV_BUILDMODE)
			to_chat(user, "<font color='blue'> ***********************************************************</font>")
			to_chat(user, "<font color='blue'> Right Mouse Button on buildmode button = Set object type</font>")
			to_chat(user, "<font color='blue'> Left Mouse Button on turf/obj          = Place objects</font>")
			to_chat(user, "<font color='blue'> Right Mouse Button                     = Delete objects</font>")
			to_chat(user, "")
			to_chat(user, "<font color='blue'> Use the button in the upper left corner to</font>")
			to_chat(user, "<font color='blue'> change the direction of built objects.</font>")
			to_chat(user, "<font color='blue'> ***********************************************************</font>")
		if(VAR_BUILDMODE)
			to_chat(user, "<font color='blue'> ***********************************************************</font>")
			to_chat(user, "<font color='blue'> Right Mouse Button on buildmode button = Select var(type) & value</font>")
			to_chat(user, "<font color='blue'> Left Mouse Button on turf/obj/mob      = Set var(type) & value</font>")
			to_chat(user, "<font color='blue'> Right Mouse Button on turf/obj/mob     = Reset var's value</font>")
			to_chat(user, "<font color='blue'> ***********************************************************</font>")
		if(THROW_BUILDMODE)
			to_chat(user, "<font color='blue'> ***********************************************************</font>")
			to_chat(user, "<font color='blue'> Left Mouse Button on turf/obj/mob      = Select</font>")
			to_chat(user, "<font color='blue'> Right Mouse Button on turf/obj/mob     = Throw</font>")
			to_chat(user, "<font color='blue'> ***********************************************************</font>")
		if(AREA_BUILDMODE)
			to_chat(user, "<font color='blue'> ***********************************************************</font>")
			to_chat(user, "<font color='blue'> Left Mouse Button on turf/obj/mob      = Select corner</font>")
			to_chat(user, "<font color='blue'> Right Mouse Button on buildmode button = Select generator</font>")
			to_chat(user, "<font color='blue'> ***********************************************************</font>")
		if(COPY_BUILDMODE)
			to_chat(user, "<font color='blue'> ***********************************************************</font>")
			to_chat(user, "<font color='blue'> Left Mouse Button on obj/turf/mob   = Spawn a Copy of selected target</font>")
			to_chat(user, "<font color='blue'> Right Mouse Button on obj/mob = Select target to copy</font>")
			to_chat(user, "<font color='blue'> ***********************************************************</font>")
