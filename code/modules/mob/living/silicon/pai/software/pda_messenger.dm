...
/datum/pai/software/pda_messenger/action_menu(mob/living/silicon/pai/user)
	...
	dat += "<b>Signal/Receiver Status:</b> <A href='byond://?src=\ref[user];software=pdamessage;toggler=1'>[(user.pda.toff) ? "<font color='red'>\[Off\]</font>" : "<font color='green'>\[On\]</font>"]</a><br><b>Ringer Status:</b> <A href='byond://?src=\ref[src];software=pdamessage;ringer=1'>[(user.pda.silent) ? "<font color='red'>\[Off\]</font>" : "<font color='green'>\[On\]</font>"]</a><br><br>"
	dat += "<ul>"
	if(!user.pda.toff)
		for (var/obj/item/device/pda/P in sortNames(get_viewable_pdas()))
			if (P == user.pda)
				continue
			dat += "<li><a href='byond://?src=\ref[user];software=pdamessage;target=\ref[P]'>[P]</a>"
			dat += "</li>"
	dat += "</ul>"
	dat += "<br><br>"
