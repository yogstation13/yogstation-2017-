...
/mob/living/silicon/ai/proc/announcement()
	...
	var/message = stripped_input(src, "WARNING: Misuse of this verb can result in you being job banned. More help is available in 'Announcement Help'", "Announcement", last_announcement)
