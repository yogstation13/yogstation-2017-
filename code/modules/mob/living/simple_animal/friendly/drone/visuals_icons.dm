...
/mob/living/simple_animal/drone/proc/pickVisualAppearence()
	picked = FALSE
	var/appearence = input("Choose your appearence!", "Appearence", "Maintenance Drone") as anything in list("Maintenance Drone", "Repair Drone", "Scout Drone")
	switch(appearence)
		if("Maintenance Drone")
			visualAppearence = MAINTDRONE
			var/colour = input("Choose your colour!", "Colour", "grey") as anything in list("grey", "blue", "red", "green", "pink", "orange")
