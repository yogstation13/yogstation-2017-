...
/datum/species/proc/handle_mutant_bodyparts(mob/living/carbon/human/H, forced_colour)
	...
	if("leaves" in mutant_bodyparts)
		if(!H.dna.features["leaves"] || H.dna.features["leaves"] == "None" || H.head && (H.head.flags_inv & HIDEHAIR) || (H.wear_mask && (H.wear_mask.flags_inv & HIDEHAIR)) || !HD || HD.status == ORGAN_ROBOTIC)
