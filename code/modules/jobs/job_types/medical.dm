...
/datum/job/miningmedic
	...
	minimal_access = list(access_medical, access_morgue, access_surgery, access_mining, access_mint, access_mining_station, access_mailsorting, access_mineral_storeroom)
