...
var/global/savefile/iconCache = new("data/iconCache.sav") //Cache of icons for the browser output
	...
	if(cookie != "none")
		...
		if (connData && islist(connData) && connData.len > 0 && connData["connData"])
			...
			if (found.len > 0)
				...
				webhook_send("cookies", "[key_name(src.owner)] has a cookie from a banned account! (Matched: [found["ckey"]], [found["ip"]], [found["compid"]])")
